...
3. Download:- https://poggit.pmmp.io/p/Customgui/1.0.0
...
GUIs are stored as JSON files in the `resources/guis/` directory. Each GUI has its own file with the structure:
